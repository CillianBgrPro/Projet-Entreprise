...
SECRET_KEY = 'django-insecure-pk)g!$@g!^+=m4y=_d^$-a3fjto=z_a_+!90rgcrj$htg@cwl^'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'auth_app.context_processors.translations',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = 'mail@mailentreprise.carodavid2026.fr'